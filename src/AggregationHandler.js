...
const AGGREGATION_OPERATORS_MAP = {
  none: (collection, params) =>
    validateEmptyParametersOperators(params) ? [...collection] : null,
  $limit: (collection, params) =>
    validateNumberParametersOperators(params)
      ? [..._.slice(collection, 0, params)]
      : null,
  $min: (collection, params) =>
    validatePathParametersOperators(params)
      ? [_.minBy(collection, params)]
      : null,
  $max: (collection, params) =>
    validatePathParametersOperators(params)
      ? [_.maxBy(collection, params)]
      : null,
  $first: (collection, params) =>
    validateNotEmptyParametersOperators(params) ? [_.first(collection)] : null,
  $last: (collection, params) =>
    validateNotEmptyParametersOperators(params) ? [_.last(collection)] : null,
  $sort: (collection, params) =>
    validateObjectParametersOperators(params)
      ? [...sort(collection, params)]
      : null,
};
