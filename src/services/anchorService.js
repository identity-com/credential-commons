...
function Anchor(impl) {
  this.impl = impl;
  this.anchor = (label, data, options) =>
    this.impl.anchor(label, data, options);
  ...
  this.verifySubjectSignature = (subject) =>
    this.impl.verifySubjectSignature(subject);
  this.verifyAttestation = (signature) =>
    this.impl.verifyAttestation(signature);
  this.revokeAttestation = (signature) =>
    this.impl.revokeAttestation(signature);
