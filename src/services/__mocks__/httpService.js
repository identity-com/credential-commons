...
function HttpServiceConstructor() {
  ...
  this.request = async (uri, options) => {
    logger.debug(
      `Mocking request for: ${JSON.stringify({ uri, options }, null, 2)}`,
    );
    ...
    const responses = [
      {
        ...
        response: {
          clientID:
            "6e0ce9b31eb13064a194c1482ed3d9d330f22df6fb4cbcc0dbebf3169dc2325b",
      ...
      },
      {
        ...
        response: {
          ...
          subject: {
            ...
            data: "testesdsd",
            signature:
              "304502210089e94f11587bf7fa202817ace9664639855a146565d4e54b9f853f31f4d7ce31022077098a904e0dda7ab947db92a3e7dd7a5d52654c286151c3cc97feb0ef4a3310",
          },
          authority: {
            pub: "xpub:dummy",
            path: "/",
