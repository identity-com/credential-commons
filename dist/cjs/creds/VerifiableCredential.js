...
VerifiableCredentialBaseConstructor.create = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(function* (identifier, issuer, expiryIn, ucas, version, evidence, signerVerifier = null) {
...
VerifiableCredentialBaseConstructor.fromJSON = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(function* (verifiableCredentialJSON, partialPresentation = false) {
...
VerifiableCredentialBaseConstructor.getAllProperties = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(function* (identifier) {
    ...
    if (vcDefinition) {
      const allProperties = yield vcDefinition.depends.reduce( /*#__PURE__*/function () {
        var _ref10 = _asyncToGenerator(function* (prev, definition) {
