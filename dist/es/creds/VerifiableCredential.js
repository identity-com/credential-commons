...
function VerifiableCredentialBaseConstructor(identifier, issuer, expiryIn, subject, ucas, evidence, signerOptions) {
  ...
  if (!_.isEmpty(ucas)) {
    ...
    this.credentialSubject = { ...this.credentialSubject,
      ...new ClaimModel(ucas)
    };
...
VerifiableCredentialBaseConstructor.create = async (identifier, issuerDid, expiryIn, subject, ucas, evidence, signerOptions = null, validate = true) => {
